            ...
            "content": [
                {
                    ...
                    "text": """
                            ...
                            Output Format:
                            Provide the extracted text exactly as it appears in the original handwritten image, maintaining all formatting, line breaks, and spatial relationships between text elements.

                            Final Instruction: Analyze both images thoroughly, then produce the most accurate transcription possible of the original handwritten document.
                            """,
                },
                {
                    "type": "image_url",
